...
$POS_JAVASCRIPTS = [ "/painel/js/curso.js" ];
$BODY_CSS        = [  ];
...
$listar_maximo_aulas = 2;
$pagamentos = $my->Datatable("select * from pagamento where person_id= ? and data_inicio <= now() and data_fim >= now() ", [ $_SESSION["id"] ] );

if(count($pagamentos) > 0) {
    $listar_maximo_aulas = 99999;
}
?>
                ...
                <?php
                    ...
                    foreach($aulas as $aula ) { 
                        ...
                        <div class="card h-100">
                            ...
                            <?php if ( $curso["acesso"] != "Pago" || ( $curso["acesso"] == "Pago" && $contador <= $listar_maximo_aulas ) ) { ?>
